...
faqs:
  - question: "Qual è la prima azione concreta del Metodo I.R.O.N.I.A.?"
    answer: "Una micro-azione di 60–90 secondi che sposta l’attenzione dal pensiero al gesto: bere un bicchiere d’acqua, camminare due minuti, aprire la finestra, rispondere a un’email semplice."
  - question: "Agire significa evitare l’emozione?"
    answer: "No. L’obiettivo è interrompere la spirale mentale, non rimuovere ciò che senti. L’azione serve per riportare il corpo in linea con ciò che hai osservato."
  - question: "Quanto deve essere grande l’azione?"
    answer: "Il minimo indispensabile per generare movimento reale. Se è troppo ambiziosa, la eviti. Se è minuscola, funziona."
  - question: "Serve forza di volontà?"
    answer: "Meno di quanto credi. Serve più chiarezza che forza: hai già identificato, ridimensionato, osservato, nominato e interrotto. L’azione è la conseguenza logica."

howto:
  name: "Applicare la A di Agisci in 120 secondi"
  description: "Una procedura minima per trasformare un loop mentale in un gesto concreto."
  totalTime: "PT2M"
  step:
    - name: "Scegli l’azione"
      text: "Deve essere minuscola: alzarti, riordinare un oggetto, mandare un messaggio semplice, fare un respiro profondo."
    - name: "Conta fino a cinque"
      text: "Evita la trattativa mentale. Cinque secondi secchi, poi muovi il corpo."
    - name: "Agisci senza perfezione"
      text: "Non ottimizzare, non speculare. Fai solo il gesto minimo previsto."
    - name: "Chiudi il ciclo"
      text: "Nota come cambia l’attivazione emotiva. Anche il 10% di differenza è già cambiamento."
---
