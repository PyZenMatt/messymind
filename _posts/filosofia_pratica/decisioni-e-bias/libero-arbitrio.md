...
<script type="application/ld+json">
{
  ...
  "mainEntity":[
    {
      "@type":"Question",
      "name":"L’esperimento di Libet ha smentito il libero arbitrio?",
      "acceptedAnswer":{"@type":"Answer","text":"No in modo definitivo: mostra processi neurali precedenti alla consapevolezza in compiti semplici. Interpretazioni (es. Schurger) suggeriscono che l’RP possa riflettere accumulo verso soglia, non un ‘ordine’ inconscio che decide al posto nostro."}
    },
    {
      "@type":"Question",
      "name":"Cos’è il readiness potential (RP)?",
      "acceptedAnswer":{"@type":"Answer","text":"È un segnale EEG che spesso precede movimenti volontari semplici. Può riflettere un accumulo graduale di attività neurale fino a una soglia, più che un comando inconscio separato."}
    },
    {
      "@type":"Question",
      "name":"Qual è la differenza tra libero arbitrio e libero agire?",
      "acceptedAnswer":{"@type":"Answer","text":"Il libero arbitrio riguarda la formazione di intenzioni secondo ragioni proprie; il libero agire è la possibilità pratica di eseguire quelle intenzioni senza impedimenti esterni. Puoi avere il primo senza il secondo e viceversa."}
    },
    {
      "@type":"Question",
      "name":"Un esempio facile di caso di Frankfurt?",
      "acceptedAnswer":{"@type":"Answer","text":"Se scegli A spontaneamente, un supervisore sarebbe intervenuto solo a impedirti B. Non avevi alternative ‘reali’, ma sei comunque responsabile perché la decisione effettiva è stata tua e nessun intervento è stato necessario."}
    },
    {
      "@type":"Question",
      "name":"La meccanica quantistica ci rende liberi?",
      "acceptedAnswer":{"@type":"Answer","text":"Non necessariamente. L’indeterminazione introduce casualità, non controllo. Le teorie compatibiliste puntano su capacità cognitive e controllo a lungo termine più che su fenomeni quantistici."}
    }
  ]
}
</script>
