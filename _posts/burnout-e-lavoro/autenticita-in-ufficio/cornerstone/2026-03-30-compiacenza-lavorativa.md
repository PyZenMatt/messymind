---
layout: post
title: "Compiacenza lavorativa: quando dire sempre sì ti svuota"
...
date: 2026-03-30
permalink: /burnout-e-lavoro/compiacenza-lavorativa/
...
howto:
  ...
  totalTime: "PT3M"
  step:
    - name: "Nota il sì automatico"
      text: >
        Riconosci l’impulso a rispondere subito per evitare attrito.
        Non serve analizzarti: basta vedere il riflesso.
    - name: "Aspetta 10 secondi"
      text: >
        Crea una pausa minima tra richiesta e risposta.
        Dieci secondi bastano per non reagire in automatico.
    - name: "Chiarisci cosa stai sacrificando"
      text: >
        Chiediti cosa salta se accetti: priorità, tempo, focus, qualità
        o margine mentale.
    - name: "Scegli un confine minimo"
      text: >
        Decidi se accettare, spostare o delimitare la richiesta.
        Non tutto va rifiutato; molto va semplicemente contenuto.
    - name: "Rispondi con una frase breve"
      text: >
        Usa una formula semplice e professionale:
        “Ora no, domani sì” oppure “Se entra questo, slitta X”.
faqs:
  - question: "Cos’è la compiacenza lavorativa?"
    answer: "È la tendenza a dire sì in automatico sul lavoro per evitare attrito, disagio o delusione altrui. Non coincide con la collaborazione sana: è una disponibilità riflessa che spesso ti costa focus, priorità e qualità."
  - question: "Perché dico sempre sì al lavoro?"
    answer: "Perché il sì ti dà un sollievo immediato: eviti tensione, salvi la reputazione e chiudi il disagio sociale del momento. Il problema è che il costo non sparisce: si sposta in avanti."
  - question: "Dire sempre sì al lavoro è collaborazione?"
    answer: "No. Collaborare non significa assorbire tutto senza filtro. Significa contribuire in modo sostenibile, con priorità chiare e confini operativi."
  - question: "Come smettere di compiacere colleghi e capo?"
    answer: "Non con grandi discorsi identitari, ma intervenendo sul meccanismo: nota il riflesso, ritarda la risposta, guarda il costo reale della richiesta e rispondi con un bordo minimo."
  - question: "Perché mi irrito dopo aver detto sì?"
    answer: "Perché spesso hai evitato attrito fuori, ma hai creato attrito dentro. L’irritazione arriva quando senti l’invasione, la priorità spostata e il focus frammentato."
  - question: "La compiacenza lavorativa può portare al burnout?"
    answer: "Da sola non basta a spiegare tutto, ma può contribuire molto. Se per mesi assorbi urgenze altrui, lavori in saturazione e cedi continuamente priorità, il rischio di stress cronico e logoramento aumenta."
redirect_from:
  - /autenticita-in-ufficio/compiacenza-lavorativa-quando-dire-sempre-si-ti-svuota/
---
...
Per il framework completo, vedi anche [**Metodo I.R.O.N.I.A.**](/mindfulness-ironica/metodo-ironia/).
