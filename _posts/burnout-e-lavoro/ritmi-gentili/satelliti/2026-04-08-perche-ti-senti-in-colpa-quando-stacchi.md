...
lcp_image_alt: "un uomo in piedi con le mani sul volto, disperato e tante dita che lo indicano in segno di colpevolezza"
lcp_image: https://res.cloudinary.com/dkoc4knvv/image/upload/f_auto,q_auto,dpr_auto,c_fill,ar_16:9,w_1600/v1775717071/pexels-yankrukov-7640494_v5ywv4.jpg
image: https://res.cloudinary.com/dkoc4knvv/image/upload/f_auto,q_auto,dpr_auto,c_fill,ar_16:9,w_1600/v1775717071/pexels-yankrukov-7640494_v5ywv4.jpg
background: https://res.cloudinary.com/dkoc4knvv/image/upload/f_auto,q_auto,dpr_auto,c_fill,ar_3:2,w_600/v1775717071/pexels-yankrukov-7640494_v5ywv4.jpg
og_image: https://res.cloudinary.com/dkoc4knvv/image/upload/f_jpg,q_auto,c_fill,ar_1.91:1,w_1200/v1775717071/pexels-yankrukov-7640494_v5ywv4.jpg
image_author_url: "https://www.pexels.com/it-it/foto/uomo-persona-triste-infelice-7640494/"
image_author: "Yan Krukau"
is_cornerstone: false
faq:
  - question: "Perché mi sento in colpa quando non faccio nulla?"
    answer: "Perché hai associato il tuo valore personale alla produttività. Quando ti fermi, il cervello interpreta la pausa come perdita di valore."
  - question: "È normale sentirsi in colpa quando si rallenta?"
    answer: "È comune, ma non è funzionale. Indica un automatismo legato alla performance, non una reale necessità."
  - question: "Come smettere di sentirsi in colpa quando si riposa?"
    answer: "Riconoscendo il meccanismo, nominando il senso di colpa e creando uno spazio prima di reagire."
  - question: "Questo comportamento può portare al burnout?"
    answer: "Sì. Se non recuperi mai davvero, accumuli stanchezza e stress, aumentando il rischio di burnout."
---
...
Se non riesci a [**spegnerti davvero**](/burnout-e-lavoro/non-stacchi-mai-davvero/)
...
Non succede perché hai fatto qualcosa di sbagliato.
Succede perché hai smesso di confermare qualcosa.
...
Non è più un intervallo neutro.
Non è più recupero.
Diventa un test.
...
Più resti attivo mentalmente, meno riesci a [**rilassarti davvero**](/burnout-e-lavoro/non-riesci-a-rilassarti/)
...
**1. Valore = output**
Ti senti a posto quando produci.

Non quando sei lucido.
Non quando scegli bene.
...
**2. Pausa = rischio**
La pausa smette di essere neutra.

Appena rallenti, parte una micro-attivazione.
Non forte, ma costante.
...
**3. Movimento = regolazione**
Qui sta il punto operativo.

Non ti muovi solo per avanzare.
Ti muovi per regolare quello stato.

Appena fai qualcosa, il disagio cala.

Non perché sia importante.
Ma perché hai ristabilito coerenza:
...
→ [Ansia da produttività: perché non ti senti mai abbastanza](/burnout-e-lavoro/ansia-da-produttivita/)
...
1. durante → **devi produrre**
2.  dopo → **non riesci a staccare**
3. in pausa → **ti senti in colpa**
...
Quando rallenti e senti partire il disagio, da dentro sembra una decisione:
*“vabbè, faccio questa cosa al volo”*
...
Ti senti sempre attivo, sempre impegnato, sempre “sul pezzo”.
Ma sotto non c’è controllo, c’è dipendenza da attivazione.

Finché ti muovi, ti sembra di avere in mano la situazione.
In realtà stai solo evitando il punto in cui la situazione ti tocca davvero: il momento in cui ti fermi e non sai stare lì senza correggerti subito.

Per questo chiamarlo disciplina è fuorviante.

La disciplina regge la frizione.
Questo meccanismo la evita.
...
**1. Riconosci il trigger (non la pausa)**
Errore comune: pensare che il problema sia fermarsi.
...
**2. Nominalo (riduci ambiguità)**
Niente analisi lunga.
...
**3. Introduci latenza (questo è il vero intervento)**
Non “restare fermo” in generale.
...
→ [**Nomina: etichettare il loop per ridurne l’impatto**](/mindfulness-ironica/nomina-il-loop/)
  
E subito dopo:  
→ [**Interrompere il pilota automatico quando parte l’impulso**](/mindfulness-ironica/interrompere-il-pilota-automatico/)
---
...
Prima:
pausa → disagio → azione

Dopo:
pausa → disagio → **spazio** → scelta
...
Prima:
valore → azione → sollievo

Dopo:
valore incerto → **resti** → non crolla niente
