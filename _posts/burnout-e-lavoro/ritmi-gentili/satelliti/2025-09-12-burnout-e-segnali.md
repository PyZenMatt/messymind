...
tags: ["burnout", "segnali burnout", "burnout al lavoro", "ritmi gentili", "stress lavoro correlato", "nebbia mentale", "esaurimento lavorativo"]
...
faqs:
  - question: "Come capire se ho il burnout?"
    answer: "Riconosci un pattern di esaurimento, distacco mentale dal lavoro e calo di efficacia che dura per settimane. Se questi segnali interferiscono con la vita quotidiana, ha senso confrontarsi con un professionista."
  - question: "Stress o burnout: come distinguerli?"
    answer: "Nello stress di solito la motivazione resta, anche se sotto pressione. Nel burnout prevalgono svuotamento, distacco e una sensazione di spegnimento che continua anche fuori orario."
  - question: "Quanto durano i sintomi del burnout?"
    answer: "Dipende dalla persona e dal contesto. Se non cambiano carico, confini o condizioni di lavoro, i segnali possono durare a lungo e peggiorare."
  - question: "Quando chiedere aiuto?"
    answer: "Se i segnali sono presenti da oltre due settimane, peggiorano o iniziano a compromettere sonno, lavoro e vita quotidiana, parlare con un medico o uno psicologo è una mossa sensata."
howto:
  name: "Self-check dei 7 segnali in 3 minuti"
  description: "Una micro-procedura per capire se stai trascurando segnali chiave del burnout al lavoro."
  totalTime: "PT3M"
  step:
    - name: "Rileva l'energia"
      text: "Valuta la tua energia ora da 1 a 5. Se sei spesso a 1 o 2 da più giorni, è un primo indicatore da non ignorare."
    - name: "Controlla il distacco"
      text: "Chiediti quanto ti senti emotivamente distante da lavoro, task o colleghi. Se prevalgono fastidio e cinismo, segnalo."
    - name: "Verifica focus ed errori"
      text: "Stai rileggendo tre volte le email, dimenticando dettagli banali o facendo errori insoliti? È un segnale utile."
    - name: "Osserva l'evitamento"
      text: "Stai rimandando compiti semplici o conversazioni normali da giorni? L'evitamento ripetuto conta."
    - name: "Ascolta il corpo"
      text: "Mal di testa, tensione cervicale, insonnia o somatizzazioni frequenti vanno segnati, non normalizzati."
---
...
Per la panoramica completa, parti anche da [**Burnout: cos’è davvero, segnali reali e prime mosse per uscirne**](/burnout-e-lavoro/burnout-cos-e-davvero/).
...
Se vuoi capire meglio la differenza tra stress e burnout, tornerà utile anche un approfondimento sullo [**stress lavoro-correlato**](/burnout-e-lavoro/stress-correlato/).
...
Se questa sensazione è costante, leggi anche [**Come prevenire il burnout con ritmi e confini più sostenibili**](/burnout-e-lavoro/prevenzione-e-cura-burnout/).
...
- capire meglio il quadro generale del [**burnout al lavoro**](/burnout-e-lavoro/burnout-cos-e-davvero/);
- lavorare su [**ritmi, confini e prevenzione**](/burnout-e-lavoro/prevenzione-e-cura-burnout/);
- distinguere il burnout dallo [**stress lavoro-correlato**](/burnout-e-lavoro/stress-correlato/);
- osservare se il tuo problema è aggravato anche da compiacenza, maschera professionale o confini poco chiari: in quel caso leggi [**Autenticità al lavoro: il costo mentale di fingere tutto il giorno**](/burnout-e-lavoro/autenticita-e-lavoro/) oppure esplora il subcluster [**Autenticità in ufficio**](/categorie/burnout-e-lavoro/autenticita-in-ufficio/).
...
- condividere questo articolo con qualcuno che sta tenendo botta solo in apparenza
