---
layout: post
title: "Perché il lavoro ti resta in testa anche sotto la doccia"
seo_title: "Perché il lavoro ti resta in testa anche quando non lavori"
...
faqs:
  ...
  - question: "È normale pensare al lavoro anche sotto la doccia?"
    answer: "Succede spesso, ma se è continuo impedisce recupero mentale reale."
  - question: "Pensare continuamente al lavoro è stress?"
    answer: "Può diventarlo quando il cervello non riesce più a uscire dalla modalità operativa."
  - question: "Come faccio a staccare mentalmente dal lavoro?"
    answer: "Serve chiudere i loop aperti e interrompere la reperibilità mentale continua."

howto:
  name: "Come interrompere il trascinamento mentale del lavoro"
  description: "Una procedura semplice per ridurre i loop mentali lavorativi fuori orario."
  totalTime: "PT5M"
  step:
    - name: "Scrivi cosa resta aperto"
      text: "Annota in una riga il task, la mail o il problema che continua a tornare."
    - name: "Definisci la prima azione utile"
      text: "Scrivi quale sarà il primo gesto concreto da fare domani o al prossimo blocco di lavoro."
    - name: "Chiudi esplicitamente la giornata"
      text: "Segna una frase di chiusura, per esempio: oggi questo resta qui."
    - name: "Riduci input e notifiche"
      text: "Evita mail, chat e app di lavoro fuori orario, almeno per il primo blocco di recupero."
---
...
Questo è il punto: non sempre il problema è che lavori troppo in quel momento. A volte il problema è che il lavoro continua a girare dopo, come una scheda del browser rimasta aperta. Ne parlo anche in [perché non stacchi mai davvero](/burnout-e-lavoro/non-stacchi-mai-davvero/) e nel pezzo sull’[ansia da produttività](/burnout-e-lavoro/ansia-da-produttivita/).
...
Su questo si collegano bene anche [controllare le mail fuori orario](/burnout-e-lavoro/controlli-mail-fuori-orario/) e [sentirsi sempre reperibile](/burnout-e-lavoro/ti-senti-sempre-reperibile/).
...
Qui entrano bene [stress correlato al lavoro](/burnout-e-lavoro/stress-correlato/) e [perché non riesci a rilassarti](/burnout-e-lavoro/non-riesci-a-rilassarti/).
...
Da lì nasce il senso di colpa quando stacchi, la reperibilità implicita, la piccola vergogna del non essere produttivo per venti minuti. Ne parlo meglio in [perché ti senti in colpa quando stacchi](/burnout-e-lavoro/perche-ti-senti-in-colpa-quando-stacchi/) e nella [compiacenza lavorativa](/burnout-e-lavoro/compiacenza-lavorativa/).
...
Se ti serve una struttura più netta, puoi usare il [Metodo I.R.O.N.I.A.](/mindfulness-ironica/metodo-ironia/) per identificare il pensiero, ridimensionarlo e passare a una micro-azione. Il punto non è pensare positivo. Il punto è interrompere il pilota automatico e [agire per chiudere il loop](/mindfulness-ironica/agisci-per-interrompere-il-loop/).
...
Però puoi iniziare a guardare i segnali. Se diventano costanti, meglio intervenire prima. Ho raccolto altri indicatori in [burnout e segnali](/burnout-e-lavoro/burnout-e-segnali/) e nella guida su [prevenzione e cura del burnout](/burnout-e-lavoro/prevenzione-e-cura-burnout/).
